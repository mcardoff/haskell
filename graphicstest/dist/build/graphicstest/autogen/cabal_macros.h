...
/* package graphicstest-0.1.0.0 */
#ifndef VERSION_graphicstest
#define VERSION_graphicstest "0.1.0.0"
#endif /* VERSION_graphicstest */
#ifndef MIN_VERSION_graphicstest
#define MIN_VERSION_graphicstest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_graphicstest */
...
#define CURRENT_COMPONENT_ID "graphicstest-0.1.0.0-2EMOv3loETjCfWTRR2B95K-graphicstest"
